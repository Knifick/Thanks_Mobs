...
public class CasketofsoulsBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public CasketofsoulsBlockEntity(BlockPos position, BlockState state) {
		super(PraporModBlockEntities.CASKETOFSOULS.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("casketofsouls");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Casket of souls");
	}

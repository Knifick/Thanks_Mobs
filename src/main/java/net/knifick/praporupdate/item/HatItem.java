...
public abstract class HatItem extends ArmorItem {
	...
	public static class Helmet extends HatItem {
		public Helmet() {
			super(ArmorItem.Type.HELMET, new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(5)).rarity(Rarity.UNCOMMON));
		}

		@Override
		public ResourceLocation getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, ArmorMaterial.Layer layer, boolean innerModel) {
			return ResourceLocation.parse("prapor:textures/entities/hat.png");
		}
	}
}
